...
def index_table_structure():
    ...
    user_info = session_service.get_user_info()
    return render_template('index_table_structure.html', page_title='数据库表结构管理', user_info=user_info)
...
def index_import():
    ...
    user_info = session_service.get_user_info()
    return render_template('index_import.html', page_title='数据导入', user_info=user_info)
...
def index_analysis():
    ...
    user_info = session_service.get_user_info()
    return render_template('index_analysis.html', page_title='数据分析', user_info=user_info)
...
def index_file_upload():
    ...
    user_info = session_service.get_user_info()
    return render_template('index_file_upload.html', page_title='文件上传', user_info=user_info)
...
def index_repair():
    ...
    user_info = session_service.get_user_info()
    return render_template('index_repair.html', page_title='数据修复', user_info=user_info)
...
def index_validation():
    ...
    user_info = session_service.get_user_info()
    return render_template('index_validation.html', page_title='数据校验', user_info=user_info)
...
def index_excel_validation():
    ...
    user_info = session_service.get_user_info()
    return render_template('index_excel_validation.html', page_title='EXCEL校验', user_info=user_info)
...
def index_sql():
    ...
    user_info = session_service.get_user_info()
    return render_template('index_sql.html', page_title='常用SQL', user_info=user_info)
...
def index_one_to_one_import():
    ...
    user_info = session_service.get_user_info()
    return render_template('index_one_to_one_import.html', page_title='一对一导入', user_info=user_info)
...
def index_prompt_templates():
    ...
    user_info = session_service.get_user_info()
    return render_template('index_prompt_templates.html', page_title='提示词模板', user_info=user_info)
...
def excel_repair():
    ...
    user_info = session_service.get_user_info()
    return render_template('excel_repair.html', page_title='EXCEL修复', user_info=user_info)
...
def settings():
    ...
    user_info = session_service.get_user_info()
    return render_template('settings.html', page_title='系统设置', user_info=user_info)
...
def settings_personal():
    ...
    # 常规请求返回完整页面
    return render_template('settings.html', page_title='个人设置', active_tab='personal-settings', user_info=user_info)
...
def setting_relational_database():
    ...
    # 常规请求返回完整页面
    return render_template('settings.html', page_title='关系型数据库设置', active_tab='db-settings', user_info=user_info)
...
def settings_vector_database():
    ...
    # 常规请求返回完整页面
    return render_template('settings.html', page_title='向量数据库设置', active_tab='vector-db-settings', user_info=user_info)
...
def settings_log():
    ...
    # 常规请求返回完整页面
    return render_template('settings.html', page_title='日志设置', active_tab='log-settings', user_info=user_info)
...
def settings_model_service():
    ...
    # 常规请求返回完整页面
    return render_template('settings.html', page_title='模型服务', active_tab='model-service', user_info=user_info)
...
def user_management():
    ...
    user_info = session_service.get_user_info()
    return render_template('user_management.html', page_title='用户管理', user_info=user_info)