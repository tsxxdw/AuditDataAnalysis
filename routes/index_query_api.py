...
# 创建蓝图
index_query_bp = Blueprint('index_query_api', __name__, url_prefix='/api/query')

@index_query_bp.route('/database_types', methods=['GET'])
...
@index_query_bp.route('/sql_templates', methods=['GET'])
...
@index_query_bp.route('/add_template', methods=['POST'])
def add_template():
    """添加SQL模板"""
...
@index_query_bp.route('/generate_sql', methods=['POST'])
def generate_sql():
    """生成SQL"""
...
@index_query_bp.route('/execute_sql', methods=['POST'])
def execute_sql():
    """执行SQL"""
